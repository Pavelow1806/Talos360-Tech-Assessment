    ...
    public class DbContext : IDbContext
    {
        public IQueryable<Supplier> Suppliers
        {
            get
            {
                ...
                {
                    new Supplier { SupplierId = 1, Name = "Acme Corporation", LeadTime = 1 },
                    new Supplier { SupplierId = 2, Name = "Sunnyside Flowers", LeadTime = 2 },
                    new Supplier { SupplierId = 3, Name = "Drinks Warehouse", LeadTime = 1 },
                    new Supplier { SupplierId = 4, Name = "TailSpin Toys", LeadTime = 3 },
                    new Supplier { SupplierId = 5, Name = "Disney", LeadTime = 6 },
                    new Supplier { SupplierId = 6, Name = "Tacky T-Shrts", LeadTime = 13 }
                }.AsQueryable();
            }
        }
        ...
        public Dictionary<int, int> BasketItems { get; set; } = new Dictionary<int, int>();
    }
}
